...
import static space.itoncek.trailcompass.proto.objects.CardCastRequirement.*;
import static space.itoncek.trailcompass.proto.objects.CardClass.*;

public enum CardType  implements Serializable {
	TimeBonusRed(Time, Uncastable),
	TimeBonusOrange(Time, Uncastable),
	TimeBonusYellow(Time, Uncastable),
	TimeBonusGreen(Time, Uncastable),
	TimeBonusBlue(Time, Uncastable),
